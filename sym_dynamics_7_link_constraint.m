...
% IT=1.33;If=0.47;It=0.2;Iua=0.04;Ifa=0.03;c1=1; c2=1;
...
KE=subs(KE,[q6 q7 dq6 dq7],[c1-q1 c2 -dq1 0]);
KE=simplify(KE)
...
PE=subs(PE,[q6 q7 dq6 dq7],[c1-q1 c2 -dq1 0]);
PE=simple(PE);
...
write_fcn_m([output_dir_m 'fcn_dynamics_matrices2.m'],{'q'},[list_q_e],{Gl,'G';Dl,'D';Cl,'C';});
% ;J_h,'J_h';Jdot_h,'Jdot_h';J_sh,'J_sh';Jdot_sh,'Jdot_sh'
