...
syms a01  a11 a21 a31 a41 a51 
syms a02  a12 a22 a32 a42 a52 
syms a03  a13 a23 a33 a43 a53 
syms a04  a14 a24 a34 a44 a54 

% -- Bezier coefficients
a1 = [a01 ; a11 ; a21 ; a31 ; a41 ; a51 ];
a2 = [a02 ; a12 ; a22 ; a32 ; a42 ; a52 ];
a3 = [a03 ; a13 ; a23 ; a33 ; a43 ; a53 ];
a4 = [a04 ; a14 ; a24 ; a34 ; a44 ; a54 ];
...
%--------------------------------------------------------------------------
[hd1,dhd1]=poly_eval_bezier(s1,5,a1);
...
[hd2,dhd2] = poly_eval_bezier(s2,5,a2);
...
[hd3,dhd3] = poly_eval_bezier(s3,5,a3);
...
[hd4,dhd4] = poly_eval_bezier(s4,5,a4);
...
list_q_e  = {'(theta_plus - theta_minus)','deltheta';'Y1','Y(1)'; 'Y2','Y(2)'; 'Y3','Y(3)'; 'Y4','Y(4)'; ...
    ...
    'a01','alpha(1,1)';'a11','alpha(1,2)';'a21','alpha(1,3)';'a31','alpha(1,4)';'a41','alpha(1,5)';'a51','alpha(1,6)';...
    'a02','alpha(2,1)';'a12','alpha(2,2)';'a22','alpha(2,3)';'a32','alpha(2,4)';'a42','alpha(2,5)';'a52','alpha(2,6)';...
    'a03','alpha(3,1)';'a13','alpha(3,2)';'a23','alpha(3,3)';'a33','alpha(3,4)';'a43','alpha(3,5)';'a53','alpha(3,6)';...
    'a04','alpha(4,1)';'a14','alpha(4,2)';'a24','alpha(4,3)';'a34','alpha(4,4)';'a44','alpha(4,5)';'a54','alpha(4,6)'};
...
write_fcn_m([output_dir_m 'fcn_liederivative_m5.m'],{'Y','alpha'},[list_q_e],{h,'h';Lfh,'Lfh';DLfh_Dx,'DLfh_Dx'});
