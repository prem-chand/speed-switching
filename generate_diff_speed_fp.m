...
%     subplot(2,4,8);plot(t+tplot,hdot_original(:,4));title('h^.4');hold on;lim=ylim; plot(impactline,[lim(1) lim(2)],'-.');
    ...
    if i==num_steps
        ...
        fp = XX(:,i+1);
        save('fixedpointforfivelink/Switching_Control/fixed_point_F=0_0.43_beta.mat','betta');
        save('fixedpointforfivelink/Switching_Control/fixed_point_F=0_0.43_beta_c.mat','beta_c');
        save('fixedpointforfivelink/Switching_Control/fixed_point_F=0_0.43_beta_ctrl.mat','beta_ctrl');
        save('fixedpointforfivelink/Switching_Control/fixed_point_F=0_0.43_fp.mat','fp');
        beta_c
        beta_s_p_tau
        fp
    end
