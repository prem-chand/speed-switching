...
dq=[q(6); q(7); q(8); q(9); q(10)];
  ...
  KE(1,1)=(47259*dq(1)*dq(2))/5000 - (507*dq(1)^2*cos(q(2) - q(3)))/625 + (7243*dq(1)*dq(3))/5000 +...
         ...
         dq(1)^2*cos(q(2) + q(4)))/125 - (144*dq(1)^2*cos(q(2)))/125 + (2693*dq(1)^2*cos(q(4)))/625 + (192*dq(1)^2*...
         cos(q(5)))/625 + (2693*dq(2)^2*cos(q(4)))/625 + (192*dq(3)^2*cos(q(5)))/625 - (192*dq(1)^2*...
         ...
         dq(4)*cos(q(2) - q(3) + q(4)))/625 - (144*dq(1)*dq(2)*cos(q(2) + q(4)))/125 - (144*dq(1)*dq(4)*cos(q(2) +...
          q(4)))/125 - (144*dq(1)*dq(2)*cos(q(2)))/125 + (5386*dq(1)*dq(2)*cos(q(4)))/625 + (384*dq(1)*dq(3)*cos(q(5)))/625 +...
          (2693*dq(1)*dq(4)*cos(q(4)))/625 + (2693*dq(2)*dq(4)*cos(q(4)))/625 + (192*dq(1)*dq(5)*cos(q(5)))/625 +...
   ...
   ME(1,1)=(4704*cos(q(1) + q(3) + q(5)))/625 - (73696*cos(q(1) + q(2) + q(4)))/625 - (131957*...
         ...
         cos(q(2)))/125 + (2693*dq(1)^2*cos(q(4)))/625 + (192*dq(1)^2*cos(q(5)))/625 + (2693*dq(2)^2*cos(q(4)))/625 + (192*...
         ...
         cos(q(2)))/125 + (5386*dq(1)*dq(2)*cos(q(4)))/625 + (384*dq(1)*dq(3)*cos(q(5)))/625 + (2693*dq(1)*dq(4)*...
         cos(q(4)))/625 + (2693*dq(2)*dq(4)*cos(q(4)))/625 + (192*dq(1)*dq(5)*cos(q(5)))/625 + (192*dq(3)*dq(5)*...
