function [De,Ce,Ge,jacF,djacF] = fcn_extended_DCG(q)
  ...
  Ce(5,6)=0;
  Ce(5,7)=0;
  Ce(6,1)=dq(2)*((1504*sin(q(1) + q(2) + q(4)))/125 + (2693*sin(q(1) + q(2)))/250) - dq(1)*((96*...
         sin(q(1) + q(3) + q(5)))/125 - (1504*sin(q(1) + q(2) + q(4)))/125 - (2693*sin(q(1) + q(2)))/250 + (507*...
         sin(q(1) + q(3)))/250 + (72*sin(q(1)))/25) - dq(3)*((96*sin(q(1) + q(3) + q(5)))/125 + (507*sin(q(1) +...
          q(3)))/250) + (1504*dq(4)*sin(q(1) + q(2) + q(4)))/125 - (96*dq(5)*sin(q(1) + q(3) + q(5)))/125;
  ...
  Ce(6,6)=0;
  Ce(6,7)=0;
  Ce(7,1)=dq(2)*((1504*cos(q(1) + q(2) + q(4)))/125 + (2693*cos(q(1) + q(2)))/250) - dq(1)*((96*...
         cos(q(1) + q(3) + q(5)))/125 - (1504*cos(q(1) + q(2) + q(4)))/125 - (2693*cos(q(1) + q(2)))/250 + (507*...
         cos(q(1) + q(3)))/250 + (72*cos(q(1)))/25) - dq(3)*((96*cos(q(1) + q(3) + q(5)))/125 + (507*cos(q(1) +...
          q(3)))/250) + (1504*dq(4)*cos(q(1) + q(2) + q(4)))/125 - (96*dq(5)*cos(q(1) + q(3) + q(5)))/125;
